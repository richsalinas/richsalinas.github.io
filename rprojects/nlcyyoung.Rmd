...
knitr::include_graphics(c("steele.jpg", "bsnell.jpg", "gallen.webp"), error = FALSE)
```
...
knitr::include_graphics(c("steeleprofile.jpg", "steelestats.PNG"), error = FALSE)
```
...
knitr::include_graphics("steelepitches.PNG", error = FALSE)
```
...
```{r, echo=FALSE, fig.show="hold", fig.align="center", fig.cap="Source: [baseball-reference.com](https://www.baseball-reference.com/)"}
knitr::include_graphics(c("snellprofile.jpg", "snellstats.PNG"), error = FALSE)
```
...
```{r, echo=FALSE, fig.show="hold", fig.align="center", fig.cap="Source: [baseball-reference.com](https://www.baseball-reference.com/)"}
knitr::include_graphics(c("gallenprofile.jpg", "gallenstats.PNG"), error = FALSE)
```
```{r}
